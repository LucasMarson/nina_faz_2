  ...
  return (
    <main className="bg-[#80E1F7] antialiased">
      <div className="flex flex-col w-full h-full">
        ...
        <Header />
        <div
          className="w-full h-[80px] sm:bg-auto bg-repeat-x bg-cover"
              ...
              <div className="flex flex-col gap-10">
                <div className="flex flex-col">
                  <div className="flex gap-4">
                    ...
                    <span className="text-5xl mb-6 text-white font-normal">
                      Quando
                    </span>
                  </div>
                  <span className="text-[#08336d]">
                    Sábado, 18 de Fevereiro de 2023 a partir de 20:00
                  </span>
                </div>
                ...
                <div className="flex flex-col">
                  <div className="flex gap-4">
                    ...
                    <span className="text-5xl mb-6 font-normal text-white ">
                      Onde
                    </span>
                  </div>
                  <span className="text-[#08336d]">
                    Esporte Clube Santa Sofia - Rua Cezira de Queiroz, Pedreira
                    - SP
                  </span>
                </div>
                <div className="flex flex-col">
        ...
        <div
          id="presence"
          className="flex mt-12 flex-col w-full items-center justify-center bg-cover bg-no-repeat bg-relative"
          style={{ backgroundImage: `url(/wave_pattern.png)` }}
        >
          <div
          ...
          >
            ...
            >
              ...
              >
                <div className="flex flex-col px-3 sm:px-8 items-center justify-center">
                  <Image
                    src="/baby_shark_yellow.webp"
                    width={130}
                    height={130}
                  ...
                  <div className="flex flex-col gap-4 text-center text-2xl">
                    <h1 className="text-4xl items font-semibold mb-12 text-[#f96b9e] drop-shadow-[2px 2px 2px #05b0cc] shadow-black">
                      Confirme sua Presença
                    </h1>
                    <span
                      className="bg-no-repeat bg-center text-32xl items-center justify-center w-[350px] sm:w-full h-[90px]"
                      style={{ backgroundImage: `url(/ribbon.svg)` }}
                    >
                      18/02/2023
                    </span>
                    <span>Sábado, a partir de 11:00</span>
                    <span className="text-[26px]">
                      A confirmação será encerrada no dia 18/02/2023
                    </span>
                  </div>
                  <Link
                    href='/presence'
